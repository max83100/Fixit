...
public class MIG_200_LCD_Rolwal extends AppCompatActivity {
    ImageView mig200lcden_europlug_image;
    ImageView mig200lcden_polarity_pin_image;
    ImageView mig200lcden_invertor_board_image;
    ImageView mig200lcden_front_board_image;
    ImageView mig200lcden_plastic_image;
    ImageView mig200lcden_control_board_image;
    ImageView mig200lcden_mech_image;
    ImageView mig200lcden_fan_image;
    Button inside;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mig200_lcd_rolwal);
        //inside = findViewById(R.id.mig200lcden_inside);
        //inside.setOnClickListener(this::onClick);
        mig200lcden_europlug_image = findViewById(R.id.mig200lcden_europlug_image);
        mig200lcden_polarity_pin_image = findViewById(R.id.mig200lcden_polarity_pin_image);
        mig200lcden_invertor_board_image = findViewById(R.id.mig200lcden_invertor_board_image);
        mig200lcden_front_board_image = findViewById(R.id.mig200lcden_front_board_image);
        mig200lcden_plastic_image = findViewById(R.id.mig200lcden_plastic_image);
        mig200lcden_control_board_image = findViewById(R.id.mig200lcden_control_board_image);
        mig200lcden_mech_image = findViewById(R.id.mig200lcden_mech_image);
        mig200lcden_fan_image = findViewById(R.id.mig200lcden_fan_image);
       // inside = findViewById(R.id.mig200lcden_inside);
//        inside.setOnClickListener(this::onClick);
    ...
    private void preload() {
        ...
        Glide.with(this).load(url)
                ...
                .into(mig200lcden_europlug_image);
        ...
        Glide.with(this).load(url2)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(mig200lcden_polarity_pin_image);
        ...
        Glide.with(this).load(url3)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(mig200lcden_invertor_board_image);

        String url4 = "https://github.com/max83100/123/blob/main/spare_parts/MIG%20200%20LCD/%D0%BB%D0%B8%D1%86%D0%BE%20DP%2003666.jpg?raw=true";
        Glide.with(this).load(url4)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(mig200lcden_front_board_image);
        ...
        Glide.with(this).load(url5)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(mig200lcden_plastic_image);

        String url6 = "https://github.com/max83100/123/blob/main/spare_parts/MIG%20200%20LCD/%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%20DP%2003532.jpg?raw=true";
        Glide.with(this).load(url6)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(mig200lcden_control_board_image);
