...
public class WSME_200_P_parts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inside = findViewById(R.id.wsme200p_inside);
...
downloadImage();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.wsme200p_inside) {
            Uri address = Uri.parse(
                    "https://drive.google.com/drive/folders/11w81R_FA_bxvSfU_0WfbFzU-GKJJ4ZRd?usp=sharing");
