...
public class ARC_315_parts extends AppCompatActivity {
    ...
    ImageView arc315lt_transform_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arc315lt_transform_image = findViewById(R.id.arc315lt_transform_image);
        downloadImage();
    }
    ...
    private void downloadImage() {
        ...
        String url4 = "https://github.com/max83100/123/blob/main/spare_parts/TRANSFORMATOR/YFYP-A1610.jpg?raw=true";
        Glide.with(this).load(url4)
                .placeholder(R.drawable.ic_launcher_foreground)
                .error(R.drawable.ic_launcher_foreground)
                .into(arc315lt_transform_image);
